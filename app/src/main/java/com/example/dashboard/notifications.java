    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        on.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendANDprintResponce("http://10.0.2.2:8080/api/modules/module_1_updatenotification/SHOW");
            }
        });
        off.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                sendANDprintResponce("http://10.0.2.2:8080/api/modules/module_1_updatenotification/HIDE");
            }
        });
    }
